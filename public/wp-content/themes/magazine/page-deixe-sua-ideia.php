		...
		<div id="content" class="clearfix" style="margin-top: 10px;">
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div class="page-content entry-content" itemprop="articleBody">
					...
					<?php // the_content(); ?>
					Utilize os campos abaixo para deixar ideias e comentários que melhore ainda mais o acesso para o nosso site. Sua ideia e/ou comentário são sempre bem-vindos e agrademos por nos ajudar a manter o site nas melhores condições.

					<?php
						echo do_shortcode( '[contact-form-7 id="2683" title="Deixe sua ideia"]' );
