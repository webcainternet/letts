...
<option value="WingWalking" <?php echo selectedopt("WingWalking", $vatletaesporte); ?>>WingWalking</option>
  ...
  <div>
    <div style="float: left; width: 325px; height: 1170px;">
        <div class="col3-1" style="width: 100%; margin: 0px; background: #F5E1CD; padding-left: 15px; border-top: 5px #ff8920 solid; height: 100%;">
...
<?php // include('banners.php') ?>
      ...
      <?php if ($_GET["page"] == "" || $_GET["page"] == "sobre") { ?>
        ...
        <h4 class="widgettitle" style="border: 0px; padding: 0px; margin: 0px; margin-bottom: 10px;">Patrocinios e apoios atuais</h4>
