		...
		<div id="content" class="clearfix" style="margin-top: 10px;">
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div class="page-content entry-content" itemprop="articleBody">
					...
					<?php // the_content(); ?>
					Utilize os campos abaixo caso queira anunciar em nosso site, iremos analisar seu anúncio e daremos um retorno o mais breve possível.

					<?php
						echo do_shortcode( '[contact-form-7 id="2678" title="Anuncie"]' );
