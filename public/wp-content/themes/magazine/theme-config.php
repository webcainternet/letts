...
$themify_theme_config['panel']['settings']['tab']['theme_settings'] = array(
	...
	'custom-module' => array(
		...
		array(
			'title' => __('Breaking News', 'themify'),
			'function' => 'breaking_news_module'
		),
		array(
			'title' => __('Related Posts', 'themify'),
			'function' => 'related_posts_module'
		),
		array(
...
$themify_theme_config['panel']['styling']['tab']['background'] = array(
	...
	'element' => array(
		...
		array(
			'title' => __('Top Navigation Background', 'themify'),
...
$themify_theme_config['panel']['styling']['tab']['top_navigation'] = array(
	'title' => __('Top Navigation', 'themify'),
	'id' => 'top_navigation',
	'element' => array(		
		array(
			'title' => __('Top Navigation Link', 'themify'),
			'id' => 'top_navigation_link',
			'selector' => '#top-nav a',
			'module' => array(
				'font-family',
				'font-size',
		...
		array(
			'title' => __('Top Navigation Hover', 'themify'),
			'id' => 'top_navigation_hover',
			'selector' => '#top-nav a:hover, #top-nav li:hover > a',
			'module' => array(
				'color',
				'text-decoration',
				'background-color'
