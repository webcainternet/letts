  ...
  <div>
    <div style="float: left; width: 325px;">
        ...
        <div style="width: 685px; float: left; margin-left: 50px;">
          ...
          <h4 class="widgettitle" style="border: 0px; padding: 0px; margin: 0px; margin-bottom: 10px;">Publicar Notícia</h4>
          <div class="galeria_profissional">
            <form id="new_post" name="new_post" method="post" action="" enctype="multipart/form-data">
             <input class="input_noticia" type="text" name="titulo_noticia" value="" placeholder="Título da Notícia">
             <textarea class="textarea_noticia" name="content_noticia"></textarea>
             <input type="file" class="input_noticia input_file" name="img_destacada">
