...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		// Accordion Start ---------------------------
		'start_titletagline_acc' => $themify_customizer->accordion_start( __( 'Site Logo', 'themify' ) ),
		...
		// Accordion Start ---------------------------
		'start_top_nav_acc' => $themify_customizer->accordion_start( __( 'Top Navigation', 'themify' ) ),

		'top_nav' => array(
			'control' => array(
				'type'    => 'nav_menu',
				'label'   => __( 'Top Navigation Menu', 'themify' ),
				'location' => 'top-nav',
			),
		),
		
		'top_nav_wrapper_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
		...
		'top_nav_link_hover_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Menu Link Hover', 'themify' ),
		...
		'top_nav_link_hover_color' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Menu Link Hover Color', 'themify' ),
		...
		'top_nav_link_active_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Menu Active Link', 'themify' ),
			...
			'selector' => '#top-nav .current_page_item a,  #top-nav .current-menu-item a',
			'prop' => 'background',
		),

		'top_nav_link_active_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Menu Active Link Color', 'themify' ),
				'show_label' => false,
		...
		'top_nav_link_active_hover_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Menu Active Link Hover', 'themify' ),
			...
			'selector' => '#top-nav .current_page_item a:hover,  #top-nav .current-menu-item a:hover',
			'prop' => 'background',
		),

		'top_nav_link_active_hover_color' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Menu Active Link Hover Color', 'themify' ),
		...
		'top_nav_dropdown_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Dropdown Container', 'themify' ),
			),
		...
		'top_nav_dropdown_padding' => array(
			'control' => array(
				'type'    => 'Themify_Padding_Control',
				'label'   => __( 'Dropdown Container Padding', 'themify' ),
				'show_label' => false,
		...
		'top_nav_dropdown_link_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Dropdown Link', 'themify' ),
			),
			'selector' => '#top-nav ul a, #top-nav .current_page_item ul a, #top-nav ul .current_page_item a, #top-nav .current-menu-item ul a, #top-nav ul .current-menu-item a',
			'prop' => 'font',
		),

		'top_nav_dropdown_link_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Dropdown Link Color', 'themify' ),
				'show_label' => false,
		...
		'top_nav_dropdown_link_background' => array(
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Dropdown Link Background', 'themify' ),
				'show_label' => false,
		...
		'top_nav_dropdown_link_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
				'label'   => __( 'Dropdown Link Border', 'themify' ),
				'show_label' => false,
		...
		'top_nav_dropdown_link_padding' => array(
			'control' => array(
				'type'    => 'Themify_Padding_Control',
				'label'   => __( 'Dropdown Link Padding', 'themify' ),
				'show_label' => false,
		...
		'top_nav_dropdown_link_margin' => array(
			'control' => array(
				'type'    => 'Themify_Margin_Control',
				'label'   => __( 'Dropdown Link Margin', 'themify' ),
				'show_label' => false,
		...
		'top_nav_dropdown_link_hover_color' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Dropdown Link Hover', 'themify' ),
		...
		'top_nav_dropdown_link_hover_background' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Dropdown Link Hover Background', 'themify' ),
			...
			'selector' => '#top-nav ul a:hover,  #top-nav .current_page_item ul a:hover,  #top-nav ul .current_page_item a:hover,  #top-nav .current-menu-item ul a:hover,  #top-nav ul .current-menu-item a:hover',
			'prop' => 'background',
		),

		'end_top_nav_acc' => $themify_customizer->accordion_end(),
		// Accordion End   ---------------------------
