jQuery(document).ready(function($) {
	...
	tinymce.create('tinymce.plugins.nemus_slider_button', {  
		init : function(ed, url) {  
			ed.addButton('nemus_slider', {  
				title : 'Nemus Slider',  
				onclick : function(e) {  
				
					if($('a#content_nemus_slider').length) {
						var offset = $('a#content_nemus_slider').offset();
					} else {
						var offset = $('.mce-i-nemus_slider').parent().offset();
					}
	...
	tinymce.PluginManager.add('nemus_slider', tinymce.plugins.nemus_slider_button);
