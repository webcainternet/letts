...
define('NEMUS_SLIDER_VERSION', '1.2.3');
if (!defined('NEMUS_SLIDER_VERSION_KEY')) define('NEMUS_SLIDER_VERSION_KEY', 'nemus_slider_version');
if (!defined('NEMUS_SLIDER_VERSION_NUM')) define('NEMUS_SLIDER_VERSION_NUM', '1.2.3');
...
function nemus_slider_shortcode( $atts, $content ){
	...
	ob_start();
		...
		<h1 class="post-title" itemprop="name" style="margin: 10px 0 0px 0; padding: 0; font-size: 2em; font-family: Oswald, sans-serif; text-transform: uppercase; letter-spacing: .05em; color: #000; line-height: 110%;">
			<?php the_title(); ?>
		</h1>
							...
							//Nao é video
								...
								<?php else: ?>
									...
									<?php
										...
										//$imgsizesl = "background-size: 720px 480px;"
									?>

									<div class="slide-image" style="<?php echo $imgsizesl; ?>; background-image:url(<?php echo $thumb[0]; ?>);height: 440px; width: 720px;margin-bottom: 10px; margin-top: 10px;"></div>
								<?php endif; ?>
								<?php
								$position = 'tl';
								if (isset($slide['caption_position'])) {
